import mpmath
from Time_series import density2, grad_log
import numpy as np
...
def gradcheck():
    ...
    for k in range(100):
        ...
        g1, g2, g3, g4 = (
            density2(i, j, sig, ah, b, c, d, lam3),
            density2(i, j, sig, a, bh, c, d, lam3),
            density2(i, j, sig, a, b, ch, d, lam3),
            density2(i, j, sig, a, b, c, dh, lam3),
        )
        f1, f2, f3, f4 = mpmath.log(g1), mpmath.log(
            g2), mpmath.log(g3), mpmath.log(g4)
